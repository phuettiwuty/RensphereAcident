              ...
              {loading && items.length === 0 ? (
                ...
                items.map((it) => (
                  <button
                    ...
                    className={`group w-full text-left rounded-2xl p-4 transition-all border-2 ${selected?.id === it.id
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-indigo-50/30 p-5 rounded-2xl flex items-center gap-4">
                        <div className="bg-white p-2.5 rounded-xl border border-indigo-100 text-indigo-600 shadow-sm">
                          <img
                            src={`https://api.dicebear.com/7.x/initials/svg?seed=${selected.line_user_id || "User"
