  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 p-6 text-white w-full">
        ...
        <div className={`inline-flex px-5 py-2 rounded-2xl text-[10px] font-black tracking-widest uppercase backdrop-blur-md border ${isFull
          ? 'bg-orange-500/20 text-orange-200 border-orange-200/20'
          : 'bg-white/10 text-white border-white/20'
          }`}>
          {isFull ? 'เต็มแล้ว' : `ว่าง 8 รอบ`}
        </div>
      </div>
    </button>
  );
